...
# 14 "ECU/BUTTON/../../MCAL/GPIO/../compiler.h" 2
# 13 "ECU/BUTTON/../../MCAL/GPIO/../mcal_std_types.h" 2
# 1 "ECU/BUTTON/../../MCAL/GPIO/../STD_library.h" 1
# 12 "ECU/BUTTON/../../MCAL/GPIO/../STD_library.h"
...
# 13 "ECU/BUTTON/../../MCAL/GPIO/../STD_library.h" 2
# 14 "ECU/BUTTON/../../MCAL/GPIO/../mcal_std_types.h" 2
# 1 "ECU/BUTTON/../../MCAL/GPIO/../../MCAL/device_confg.h" 1
# 15 "ECU/BUTTON/../../MCAL/GPIO/../mcal_std_types.h" 2
# 40 "ECU/BUTTON/../../MCAL/GPIO/../mcal_std_types.h"
...
# 9 "ECU/BUTTON/button.c" 2


u8 BUTTON_INTIALIZE (button_confg *ptr){

        u8 RET = 0x01;
        GPIO_confg pre ={.port =ptr->port , .pin= ptr->pin , .direction = GPIO_DIRECTION_INPUT , .logic = ptr->state};
        if(((void*)0) == ptr){
            RET = 0x00 ;
        }
        else {
            RET = GPIO_PIN_DIRECTION_INTIALIZE(&pre);
...
u8 BUTTON_READ_STATE (button_confg *ptr,button_state *state){
        ...
        if(((void*)0) == ptr){
            ...
            RET = GPIO_PIN_READ_LOGIC (&pre ,&btn_log);
            switch (ptr->connrction){
                    case BUTTON_ACTIVE_HIGH :
                        if(btn_log == GPIO_HIGH){
