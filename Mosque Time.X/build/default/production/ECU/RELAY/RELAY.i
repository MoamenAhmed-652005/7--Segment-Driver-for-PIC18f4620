...
# 10 "ECU/RELAY/RELAY.c"
# 1 "ECU/RELAY/RELAY.h" 1
# 12 "ECU/RELAY/RELAY.h"
# 1 "ECU/RELAY/../../MCAL/GPIO/GPIO.h" 1
# 11 "ECU/RELAY/../../MCAL/GPIO/GPIO.h"
...
# 14 "ECU/RELAY/../../MCAL/GPIO/../compiler.h" 2
# 13 "ECU/RELAY/../../MCAL/GPIO/../mcal_std_types.h" 2
# 1 "ECU/RELAY/../../MCAL/GPIO/../STD_library.h" 1
# 12 "ECU/RELAY/../../MCAL/GPIO/../STD_library.h"
...
# 13 "ECU/RELAY/../../MCAL/GPIO/../STD_library.h" 2
# 14 "ECU/RELAY/../../MCAL/GPIO/../mcal_std_types.h" 2
# 1 "ECU/RELAY/../../MCAL/GPIO/../../MCAL/device_confg.h" 1
# 15 "ECU/RELAY/../../MCAL/GPIO/../mcal_std_types.h" 2
# 40 "ECU/RELAY/../../MCAL/GPIO/../mcal_std_types.h"
...
u8 RELAY_INTIALIZE (relay_confg *ptr);
u8 RELAY_SWITCH_ON (relay_confg *ptr);
u8 RELAY_SWITCH_OFF (relay_confg *ptr);
# 11 "ECU/RELAY/RELAY.c" 2
...
u8 RELAY_INTIALIZE (relay_confg *ptr){
    ...
    u8 RET = 0x01;
     if(((void*)0)== ptr){
         ...
         RET = GPIO_PIN_INTIALIZED(&(ptr->def));
...
u8 RELAY_SWITCH_ON (relay_confg *ptr){
    u8 RET = 0x01;
     if(((void*)0)== ptr){
         ...
         RET = GPIO_PIN_WRITE_LOGIC(&(ptr->def),GPIO_HIGH);
...
u8 RELAY_SWITCH_OFF (relay_confg *ptr){
    ...
    u8 RET = 0x01;
     if(((void*)0)== ptr){
         ...
         RET = GPIO_PIN_WRITE_LOGIC(&(ptr->def),GPIO_LOW);
