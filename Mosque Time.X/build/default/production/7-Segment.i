...
# 1 "./MCAL/GPIO/../STD_library.h" 1
# 12 "./MCAL/GPIO/../STD_library.h"
...
# 13 "./MCAL/GPIO/../STD_library.h" 2
# 14 "./MCAL/GPIO/../mcal_std_types.h" 2
# 1 "./MCAL/GPIO/../../MCAL/device_confg.h" 1
# 15 "./MCAL/GPIO/../mcal_std_types.h" 2
# 40 "./MCAL/GPIO/../mcal_std_types.h"
...
u8 SEG_INTIALIZED (SEG_Confg *ptr){
    u8 RET = 0x01 ;
   if (((void*)0) == ptr )
   {
       RET = 0x00 ;
       ...
       for (int i = 0 ; i<4 ; i++){
           RET = GPIO_PIN_INTIALIZED (&(ptr->SEG_PINS[i]));
       }
...
u8 SEG_WRITE_DATA (SEG_Confg *ptr,u8 NUM ){
      ...
      u8 RET = 0x01 ;
   if (((void*)0) == ptr || NUM <0 || NUM >10 )
   {
       RET = 0x00 ;
   }
   else {
       for (int i =0 ; i<4 ;i++){
            RET = GPIO_PIN_WRITE_LOGIC (&(ptr->SEG_PINS[i]),((NUM >> i)& 1));
          }
      }
