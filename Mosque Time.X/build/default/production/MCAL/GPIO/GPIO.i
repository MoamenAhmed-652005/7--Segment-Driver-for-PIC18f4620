...
# 1 "MCAL/GPIO/../GPIO/GPIO.h" 1
# 11 "MCAL/GPIO/../GPIO/GPIO.h"
# 1 "MCAL/GPIO/../GPIO/../mcal_std_types.h" 1
# 12 "MCAL/GPIO/../GPIO/../mcal_std_types.h"
# 1 "MCAL/GPIO/../GPIO/../compiler.h" 1
# 13 "MCAL/GPIO/../GPIO/../compiler.h"
...
# 14 "MCAL/GPIO/../GPIO/../compiler.h" 2
# 13 "MCAL/GPIO/../GPIO/../mcal_std_types.h" 2
# 1 "MCAL/GPIO/../GPIO/../STD_library.h" 1
# 12 "MCAL/GPIO/../GPIO/../STD_library.h"
...
# 13 "MCAL/GPIO/../GPIO/../STD_library.h" 2
# 14 "MCAL/GPIO/../GPIO/../mcal_std_types.h" 2
# 1 "MCAL/GPIO/../GPIO/../../MCAL/device_confg.h" 1
# 15 "MCAL/GPIO/../GPIO/../mcal_std_types.h" 2
# 40 "MCAL/GPIO/../GPIO/../mcal_std_types.h"
...
u8 GPIO_PIN_INTIALIZED(GPIO_confg *ptr){
     ...
     u8 RET = 0x01;
    if(((void*)0) == ptr || ptr->port > 5 - 1||ptr->pin > 8 -1 )
    {
        RET = 0x00 ;
    }
    else {
...
u8 GPIO_PIN_GET_DIRECTION(GPIO_confg *ptr,direction_t *state){
      u8 RET = 0x01;
    if(((void*)0) == ptr || ptr->port > 5 - 1||ptr->pin > 8 -1||(((void*)0)== state) )
    {
        RET = 0x00 ;
    }
    else {
        *state = ((*TRIS_REG[ptr->port] >> ptr->pin)& 1);
    }
...
u8 GPIO_PIN_READ_LOGIC(GPIO_confg *ptr,logic_t *state){
    ...
    if(((void*)0) == ptr || ptr->port > 5 - 1||ptr->pin > 8 -1 )
    {
       ...
       *state = ((*PORT_REG[ptr->port] >> ptr->pin)& 1);
