...
# 14 "MCAL/ADC/../GPIO/../compiler.h" 2
# 13 "MCAL/ADC/../GPIO/../mcal_std_types.h" 2
# 1 "MCAL/ADC/../GPIO/../STD_library.h" 1
# 12 "MCAL/ADC/../GPIO/../STD_library.h"
...
# 13 "MCAL/ADC/../GPIO/../STD_library.h" 2
# 14 "MCAL/ADC/../GPIO/../mcal_std_types.h" 2
# 1 "MCAL/ADC/../GPIO/../../MCAL/device_confg.h" 1
# 15 "MCAL/ADC/../GPIO/../mcal_std_types.h" 2
# 40 "MCAL/ADC/../GPIO/../mcal_std_types.h"
...
typedef struct {
    ...
    ADC_Conversion_Clock convertion_clock ;
    ADC_Time_Acquisition time_aquiasition ;
    ADC_Channel channel_select ;
    u8 voltage_ref :1 ;
    u8 formate_result :1 ;
    u8 reserved :6 ;
}ADC_Confg;
...
u8 ADC_INITIALIZE (ADC_Confg *ptr);
u8 ADC_DEINITIALIZE (ADC_Confg *ptr);
u8 ADC_CHANNEL_SELECT (ADC_Channel channel_select);
u8 ADC_START_COVERSION (void);
u8 ADC_IS_CONERSION_DONE (ADC_Confg *ptr,u8 *conv_state);
u8 ADC_GET_CONVERSION_RESULT (ADC_Confg *ptr,u8 *result);
u8 ADC_GET_CONVERSION_BlOCKING (ADC_Confg *ptr,ADC_Channel channel_select,u16 *result);
# 9 "MCAL/ADC/ADC.c" 2

static void ADC_INPUT_CHANNEL_CONFG(ADC_Channel channel_select );
static void ADC_CONFG_VOLT_REF(u8 volt);
static void ADC_SELECT_RESULT_FORMATE(u8 formate);
...
u8 ADC_INITIALIZE (ADC_Confg *ptr){
    ...
    if (((void*)0) == ptr) {
        ...
        ADCON2bits.ACQT = (ptr->time_aquiasition);

        ADCON0bits.CHS = (ptr->channel_select);
        ADC_INPUT_CHANNEL_CONFG(ptr->channel_select);

        ADCON2bits.ACQT = (ptr->time_aquiasition);

        ADCON2bits.ADCS = (ptr->convertion_clock);

        ADC_SELECT_RESULT_FORMATE(ptr->formate_result);

        ADC_CONFG_VOLT_REF(ptr->voltage_ref);
...
u8 ADC_CHANNEL_SELECT (ADC_Channel channel_select){
    ...
    if( channel_select > (13 -1) ){
        ...
        ADC_INPUT_CHANNEL_CONFG(channel_select);
...
u8 ADC_IS_CONERSION_DONE (ADC_Confg *ptr,u8 *conv_state) {
    ...
    if ((((void*)0) == ptr) || (((void*)0) == conv_state)) {
        RET = 0x00;

    } else {
        RET = (ADCON0bits.GODONE);
        if (RET == 0) {
            *conv_state = 1;
        } else {
            *conv_state = 0;
