...
# 1 "./application.h" 1
# 12 "./application.h"
# 1 "./../Embeded_Project.X/MCAL/GPIO/GPIO.h" 1
# 11 "./../Embeded_Project.X/MCAL/GPIO/GPIO.h"
# 1 "./../Embeded_Project.X/MCAL/GPIO/../mcal_std_types.h" 1
# 12 "./../Embeded_Project.X/MCAL/GPIO/../mcal_std_types.h"
# 1 "./../Embeded_Project.X/MCAL/GPIO/../compiler.h" 1
# 13 "./../Embeded_Project.X/MCAL/GPIO/../compiler.h"
...
# 14 "./../Embeded_Project.X/MCAL/GPIO/../compiler.h" 2
# 13 "./../Embeded_Project.X/MCAL/GPIO/../mcal_std_types.h" 2
# 1 "./../Embeded_Project.X/MCAL/GPIO/../STD_library.h" 1
# 12 "./../Embeded_Project.X/MCAL/GPIO/../STD_library.h"
...
# 13 "./../Embeded_Project.X/MCAL/GPIO/../STD_library.h" 2
# 14 "./../Embeded_Project.X/MCAL/GPIO/../mcal_std_types.h" 2
# 1 "./../Embeded_Project.X/MCAL/GPIO/../../MCAL/device_confg.h" 1
# 15 "./../Embeded_Project.X/MCAL/GPIO/../mcal_std_types.h" 2
# 40 "./../Embeded_Project.X/MCAL/GPIO/../mcal_std_types.h"
...
# 12 "./../Embeded_Project.X/MCAL/GPIO/GPIO.h" 2
...
u8 LED_INTIALIZE (led_confg *ptr);
u8 LED_TURN_ON (led_confg *ptr);
u8 LED_TURN_OFF (led_confg *ptr);
u8 LED_TOGGLE (led_confg *ptr);
# 14 "./application.h" 2
# 1 "./ECU/BUTTON/button.h" 1
# 11 "./ECU/BUTTON/button.h"
# 1 "./ECU/LED/../../MCAL/GPIO/GPIO.h" 1
# 12 "./ECU/BUTTON/button.h" 2
...
u8 BUTTON_INTIALIZE (button_confg *ptr);
u8 BUTTON_READ_STATE (button_confg *ptr,button_state *state);
# 15 "./application.h" 2
# 1 "./7-Segment.h" 1
# 12 "./7-Segment.h"
# 1 "./ECU/LED/../../MCAL/GPIO/GPIO.h" 1
...
typedef struct {
    GPIO_confg SEG_PINS [4];
    seg_type seg_connection ;

}SEG_Confg;



u8 SEG_INTIALIZED (SEG_Confg *prt);
u8 SEG_WRITE_DATA (SEG_Confg *ptr,u8 NUM );
# 16 "./application.h" 2
# 37 "./application.h"
u8 APP_INITIALIZE (void);
void Bouncing_check (button_state btn_state , button_state *btn_vaild);
# 10 "Mosque_Time_APP.c" 2
...
void main(void)
{
    ...
    while (1){
        ...
        ret = SEG_WRITE_DATA(&Segment_1_min , 0);
        ret = SEG_WRITE_DATA(&Segment_2_min , 0);
    }
